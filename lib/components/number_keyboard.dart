...
class _MyKeyBoardState extends State<MyKeyBoard> {
  ...
  List<Widget> _buildItem(BuildContext context) {
    ...
    return List.generate(
        ...
        (int index) => HighLightWell(
              ...
              child: Container(
                color: index == 15 ? AppColors.app_main : Colors.white,
  ...
  static TextStyle _numberStyle =
      TextStyle(fontSize: 40.sp, color: AppColors.dark);
  ...
  Widget _buildSubItem(int index, double parentWidth) {
    switch (index) {
      ...
      case 11:
        return Text(
          '继续',
          style: TextStyle(fontSize: 30.sp, color: AppColors.dark),
        );
        break;
      case 12:
        return Text(
