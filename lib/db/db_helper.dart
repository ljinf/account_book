import 'dart:convert';
import 'package:account_book/model/bill_record_group.dart';
import 'package:account_book/model/bill_record_response.dart';
import 'package:account_book/model/budget_model.dart';
import 'package:account_book/model/category_model.dart';
    ...
    try {
      if (model.id == null) {
        ...
        result = await dbClient!
            .update(_billTableName, map, where: 'id == ${model.id}');
      }
    } catch (e) {
